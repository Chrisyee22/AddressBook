...
describe("ContactController", () =>{
  ...
  describe("#addContact()", () => {
    it("should add a single contact into the book", (done) => {
      this.book.addContact("Bernie", "234-453-0987")
      .then((contact) => {
        expect(contact.name).toBe("Bernie");
        expect(contact.phone).toBe("234-453-0987");
        done();
      })
      .catch((err) => {
        done();
  ...
  describe("#getContacts()", () => {
    ...
    it("should return an array of contacts when contacts are available", (done) => {
      this.book.addContact("Bernie", "234-453-0987", "bernie@theweekend.com")
      .then(()=>{
        this.book.getContacts()
        .then((contacts) => {
